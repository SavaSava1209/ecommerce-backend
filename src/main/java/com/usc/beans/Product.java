...
public class Product {
	...
	public Product(Long id, ProductCategory category, String sku, String name, String description, double unitPrice,
	...
	public Product(Long id, ProductCategory category, String sku, String name, String description, Long unitPrice,
			String imageUrl, boolean active, int unitsInStock, Date dateCreated) {
		super();
		this.id = id;
		this.category = category;
		this.sku = sku;
